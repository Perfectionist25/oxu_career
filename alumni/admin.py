...
class AlumniAdmin(admin.ModelAdmin):
    ...
    list_display = ('user', 'graduation_year', 'faculty', 'current_position', 'company', 'is_mentor', 'is_visible')
    list_filter = ('graduation_year', 'faculty', 'is_mentor', 'is_visible', 'created_at')
    search_fields = ('user__username', 'user__first_name', 'user__last_name', 'user__email', 'faculty', 'company')
    ...
    fieldsets = (
        ...
        ('О себе', {
            'fields': ('bio', 'photo', 'profile_photo')
        }),
        ('Настройки видимости', {
    ...
    def profile_photo(self, obj):
        ...
        return "Нет фото"
    profile_photo.short_description = "Фото профиля"
...
class CompanyAdmin(admin.ModelAdmin):
    ...
    def company_logo(self, obj):
        ...
        return "Нет логотипа"
    company_logo.short_description = "Логотип"

@admin.register(Job)
class JobAdmin(admin.ModelAdmin):
    """Админ-панель для вакансий"""
    list_display = ('title', 'company', 'employment_type', 'location', 'salary_range', 'is_active', 'created_at')
    list_filter = ('employment_type', 'remote_work', 'currency', 'is_active', 'created_at')
...
class EventAdmin(admin.ModelAdmin):
    ...
    list_display = ('title', 'event_type', 'date', 'time', 'location', 'registration_required', 'is_active')
...
class MentorshipAdmin(admin.ModelAdmin):
    ...
    list_filter = ('status', 'expected_duration', 'communication_preference', 'created_at')
...
class MessageAdmin(admin.ModelAdmin):
    ...
    search_fields = ('sender__user__username', 'receiver__user__username', 'subject', 'body')
