...
from . import views
from .feeds import LatestNewsFeed, LatestJobsFeed, UpcomingEventsFeed, AllUpdatesFeed
...
urlpatterns = [
    ...
    # Менторство
    path('mentorship/<slug:alumni_slug>/request/', views.mentorship_request, name='mentorship_request'),
    
    # Соединения
    path('connection/<slug:alumni_slug>/request/', views.connection_request, name='connection_request'),
