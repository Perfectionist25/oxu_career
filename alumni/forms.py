...
class AlumniRegistrationForm(UserCreationForm):
    ...
    email = forms.EmailField(
        ...
        widget=forms.EmailInput(
            attrs={"class": "form-control", "placeholder": "Emailingizni kiriting"}
        ),
    )
    name = forms.CharField(
        max_length=255,
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "To'liq ismingiz"}
        ),
    )
    graduation_year = forms.IntegerField(
        ...
        widget=forms.NumberInput(
            attrs={"class": "form-control", "placeholder": "Bitirgan yilingiz"}
        ),
    )
    phone = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Telefon raqamingiz"}
        ),
    )
    ...
    def clean(self):
        ...
        if (
            ...
            raise ValidationError(
                "Minimal maosh maksimal maoshdan katta bo'lmasligi kerak."
            )
    ...
    class Meta:
        ...
        widgets = {
            ...
            "tags": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "vergul bilan ajrating"}
            ),
        }
...
class ContactForm(forms.Form):
    ...
    email = forms.EmailField(
        widget=forms.EmailInput(
            attrs={"class": "form-control", "placeholder": "Emailingiz"}
        )
    )
    ...
    message = forms.CharField(
        widget=forms.Textarea(
            attrs={"class": "form-control", "rows": 5, "placeholder": "Xabaringiz..."}
        )
    )
...
class SearchForm(forms.Form):
    ...
    faculty = forms.ChoiceField(
        required=False,
        # Ensure both sides are plain str to satisfy static typing when
        # concatenating with lazy translation _StrPromise values.
        choices=[("", "--- Barcha fakultetlar ---")] + [
            (key, str(label)) for key, label in Alumni.FACULTY_CHOICES
        ],
    ...
    graduation_year_from = forms.IntegerField(
        ...
        max_value=2030,
        widget=forms.NumberInput(
            attrs={"class": "form-control", "placeholder": "Bitirgan yildan"}
        ),
    )
    graduation_year_to = forms.IntegerField(
        ...
        max_value=2030,
        widget=forms.NumberInput(
            attrs={"class": "form-control", "placeholder": "Bitirgan yilgacha"}
        ),
    )
