...
from .models import JobApplication, JobAlert, Job
...
def send_application_confirmation(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        html_message = render_to_string('jobs/emails/application_confirmation.html', context)
    ...
    if created and instance.is_active:
        ...
        for alert in alerts:
            ...
            if alert.keywords:
                ...
                matches = any(
                    kw in instance.title.lower() or 
                    kw in instance.description.lower() or
                    kw in instance.skills_required.lower()
                    for kw in keywords
                )
                if not matches:
                    continue
