    ...
    class Meta:
        ...
        widgets = {
            ...
            "headquarters": forms.TextInput(
                attrs={
                    "class": "form-control",
                    "placeholder": _("Headquarters location"),
                }
            ),
    ...
    class Meta:
        ...
        widgets = {
            ...
            "department": forms.TextInput(
                attrs={"class": "form-control", "placeholder": _("Department")}
            ),
...
class JobForm(forms.ModelForm):
    ...
    def clean(self) -> Dict[str, Any]:
        ...
        salary_min: Optional[int] = cleaned_data.get("salary_min")
        salary_max: Optional[int] = cleaned_data.get("salary_max")
