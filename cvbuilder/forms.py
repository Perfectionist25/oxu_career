...
from .models import CV, Experience, Education, Skill, Language
...
class CVForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'title', 'salary_expectation', 'summary'
        ]
        widgets = {
            'full_name': forms.TextInput(attrs={
                'class': 'form-control', 
                'placeholder': 'Familiya Ism Otchestvo'
            }),
            ...
            'summary': forms.Textarea(attrs={
                'class': 'form-control', 
                'rows': 4,
                'placeholder': 'Asosiy ko\'nikmalar va tajriba. Qisqacha professional tajribangiz va kompetensiyalaringizni tasvirlab bering.'
            }),
        }
...
class QuickCVForm(forms.ModelForm):
    ...
    skills_text = forms.CharField(
        ...
        widget=forms.Textarea(attrs={
            'class': 'form-control',
            'rows': 3,
            'placeholder': 'Asosiy ko\'nikmalaringizni vergul bilan ajratib sanab o\'ting.\nMasalan: Python, Django, PostgreSQL, Git, Docker'
        })
    )
    ...
    class Meta:
        ...
        widgets = {
            ...
            'summary': forms.Textarea(attrs={
                'class': 'form-control', 
                'rows': 4,
                'placeholder': 'Ish tajribangiz, asosiy yutuqlar va professional maqsadlaringizni tasvirlab bering...'
            }),
        }
