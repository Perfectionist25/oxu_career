...
class CV(models.Model):
    ...
    title = models.CharField(max_length=200, verbose_name="Название резюме", default="Мое резюме")
    template = models.ForeignKey(CVTemplate, on_delete=models.SET_NULL, null=True, blank=True, verbose_name="Шаблон")
    ...
    salary_expectation = models.IntegerField(null=True, blank=True, verbose_name="Зарплатные ожидания")
...
class Education(models.Model):
    ...
    degree = models.CharField(max_length=50, choices=DEGREE_CHOICES, verbose_name="Степень")
