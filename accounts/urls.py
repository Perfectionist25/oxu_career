...
urlpatterns = [
    ...
    path("companies/search/", views.search_orginfo_company, name="search_orginfo_company"),
    path("companies/fetch/", views.fetch_orginfo_company_details, name="fetch_orginfo_company"),
