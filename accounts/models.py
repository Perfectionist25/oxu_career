...
class CustomUser(AbstractUser):
    ...
    hemis_data = models.JSONField(
        blank=True, 
        null=True,
        verbose_name=_("Hemis ma'lumotlari")
    )
    ...
    email_notifications = models.BooleanField(
        default=True, 
        verbose_name=_("Email xabarnomalari")
    )
    job_alerts = models.BooleanField(
        default=True, 
        verbose_name=_("Ish ogohlantirishlari")
    )
    ...
    is_active_employer = models.BooleanField(
        default=False,
        verbose_name=_("Faol ish beruvchi")
    )
    
    # Статистика
    profile_views = models.PositiveIntegerField(
        default=0, 
        verbose_name=_("Profil ko'rishlar")
    )
    ...
    def can_create_jobs(self):
        ...
        return self.user_type in ['employer', 'admin', 'main_admin'] and self.is_active_employer
...
class EmployerProfile(models.Model):
    ...
    company_email = models.EmailField(
        blank=True,
        verbose_name=_("Kompaniya emaili")
    )
    company_phone = PhoneNumberField(
        blank=True,
        null=True,
        verbose_name=_("Kompaniya telefoni")
    )
    company_website = models.URLField(
        blank=True,
        verbose_name=_("Kompaniya veb sayti")
    )
    
    # Социальные сети компании
    company_linkedin = models.URLField(
        blank=True,
        verbose_name=_("Kompaniya LinkedIn")
    )
    company_telegram = models.URLField(
        blank=True,
        verbose_name=_("Kompaniya Telegram")
    )
    ...
    founded_year = models.IntegerField(
        null=True,
        blank=True,
        verbose_name=_("Tashkil etilgan yil")
    )
    headquarters = models.CharField(
        max_length=255,
        blank=True,
        verbose_name=_("Bosh qarorgoh")
    )
    
    # Статистика
    jobs_posted = models.PositiveIntegerField(
        default=0,
        verbose_name=_("E'lon qilingan ishlar")
    )
    total_views = models.PositiveIntegerField(
        default=0,
        verbose_name=_("Jami ko'rishlar")
    )
    
    is_verified = models.BooleanField(
        default=False,
        verbose_name=_("Tasdiqlangan kompaniya")
    )
...
class StudentProfile(models.Model):
    ...
    desired_position = models.CharField(
        max_length=255,
        blank=True,
        verbose_name=_("Istagan lavozim")
    )
    ...
    resumes_created = models.PositiveIntegerField(
        default=0,
        verbose_name=_("Yaratilgan rezyumelar")
    )
    jobs_applied = models.PositiveIntegerField(
        default=0,
        verbose_name=_("Ariza berilgan ishlar")
    )
...
def create_user_activity_on_signup(sender, instance, created, **kwargs):
    ...
    if created:
        UserActivity.objects.create(
            ...
            description=_('Foydalanuvchi ro`yxatdan o`tdi')
        )
